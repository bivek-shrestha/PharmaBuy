    ...
    <div class="content full-page dashboard">
        <div class="page-header">
            <div class="page-title">
                <h1>Add Four Advertisement Banner</h1>
            </div>

            <div class="page-action">
                <a href="add_four_images"><button class="btn btn-primary" style="padding: 10px;">Add Images</button></a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/helloworld/delete_four_image', $image->id) }}"><button class="btn deleteButton">Delete</button></a>
                                </td>
                            </tr>
                            @php
                            $i++;
