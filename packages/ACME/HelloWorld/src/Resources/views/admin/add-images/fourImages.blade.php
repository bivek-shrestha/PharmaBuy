    ...
    <div class="content full-page dashboard">
        <div class="page-header">
            <div class="page-title">
                <h1>
                    <i onclick="window.location = 'http://127.0.0.1:8000/admin/helloworld/four'" class="icon angle-left-icon back-link"></i>
                    Add Four Advertisement Banner
                </h1>
            </div>
        ...
        <div class="page-content">
            <div slot="body" class="body_content">
                <form action="{{ route('helloworld.admin.addimages.storeFourImage') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="container">
                        <div class="row">
                            <div class="title">
                            ...
                            <div class="type">
                                ...
                                <input class="form-control" type="banner_text" name="banner_type" value="Four" readonly>
                            </div>
                            <div class="hyperlink">
