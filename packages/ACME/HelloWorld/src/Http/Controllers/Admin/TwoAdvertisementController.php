...
class TwoAdvertisementController extends Controller
{
    ...
    public function updateImage(Request $request, $id){
        $values = HelloWorld:: find($id);
            ...
            if($request->hasFile('image')){
                $destination = 'images/advertisement_banner/TwoAdsBanner/'.$values->image;
                ...
                $extension = $images->getClientOriginalExtension();
                $filename = time().'.'.$extension;
                $images->move('images/advertisement_banner/TwoAdsBanner/', $filename);
    ...
    public function deleteImage($id){
        ...
        $destination = 'images/advertisement_banner/TwoAdsBanner/'.$banner_details->image;
        if(File::exists($destination)){
            File::delete($destination);
        }
